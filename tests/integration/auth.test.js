...
describe('Auth routes', () => {
  describe('POST /v1/users/new', () => {
    ...
    test('should return 201 and successfully register user if request data is ok', async () => {
      const res = await request(app).post('/v1/users/new').send(newUser).expect(httpStatus.CREATED);
      ...
      expect(dbUser).toMatchObject({ username: newUser.username, role: 'employee' });
  ...
  describe('POST /v1/users/refresh-tokens', () => {
